#ifndef __I2C_FAMELI__
#define __I2C_FAMELI__
/*
 * File:   main.c
 * Author: FAMELI Tech
 *
...
#include <xc.h> 
    ...
    #define SCL_PORT PORTB		//The port where the SCL pin is located
    #define SCL_TRIS TRISB		//The tristate register for the SCL bit
...
uint16_t I2C_ReadRegister2(char deviceAddress, char registerAddress);// lee un registro de 16 bits en 2 transacciones
